...
function UserArticles(props){
    ...
    useEffect( () => {
        axios.get('http://localhost:5000/user/profile/liked',{
    ...
    useEffect( () => {
        axios.get('http://localhost:5000/user/profile/saved',{ withCredentials: true }).then((res) => {
            console.log(res);
    ...
    return (
        ...
        <TabPanel value = {0} >
            ...
            <div className = "article_card_profile"><NewsCardItem save={false} cardarticle={article}/></div>
          ))}
            </div>
        </TabPanel>
        <TabPanel value = {1}>
            ...
            <div className = "article_card_profile"><NewsCardItem save={true} cardarticle={article}/></div>
          ))}
            </div>
        </TabPanel>
      </Tabs>
