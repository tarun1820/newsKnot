    ...
    <div id="signupBox">
        ...
        <form onSubmit={handleSubmit} style={{marginTop:0}}>
          <label className="label-form-item" >Username</label><br />
            ...
            <input required minLength={3} onChange={handleChange} value={loginCredtials.username} name="username" type="text" id="username-textField" className="input-form-item" placeholder="Type Your Username" /><br/>
            </div>
            <hr className="line-btw-items" />
            <label className="label-form-item" >Email</label><br/>
            <div className="image-side-inputfield">
            <img alt="" src={envelopeopen} className="icon" />
            <input required onChange={handleChange} value={loginCredtials.email} name="email"  type="email" id="" className="input-form-item" placeholder="Enter Your Email" /><br/>
            </div>
            <hr className="line-btw-items" />
            <label className="label-form-item" >Passcode</label><br/>
            <div className="image-side-inputfield" >
            <img alt="" src={locksolid} className="icon" />
            <input required minLength={8} onChange={handleChange} value={loginCredtials.password} name="password" type="password" id="passcode-field" className="input-form-item" placeholder="Type Your Passcode" /><br />
            </div>
            <hr className="line-btw-items" />
