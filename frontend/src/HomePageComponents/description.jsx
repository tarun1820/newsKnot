...
function Description(props){
    return (
        ...
        <div className = "Description_box__style">
            ...
            Phasellus pulvinar facilisis lobortis. Sed imperdiet eros 
            sit amet tellus luctus, eget
        </div>
        <div>
            <Button  link="/signup" className = "Description_box__button">Getting Started</Button>
        </div>
        </div>
    )
}
